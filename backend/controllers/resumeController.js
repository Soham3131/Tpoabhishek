...
exports.generateResumePDF = async (req, res) => {
    ...
    try {
        ...
        const resumeData = resume.toObject();
        const resumeHtml = generateResumeHtml(resumeData); // This is where the function is called
...
// Helper function to generate HTML for the resume PDF
// This function needs to be defined BEFORE it is called in generateResumePDF
      ...
      <body>
          <div class="section">
              ...
              <div class="contact-info">
                  ...
                  ${resumeData.linkedin ? `<p><strong>LinkedIn:</strong> <a href="${resumeData.linkedin}">${resumeData.linkedin}</a></p>` : ''}
                  ${resumeData.github ? `<p><strong>GitHub:</strong> <a href="${resumeData.github}">${resumeData.github}</a></p>` : ''}
                  ${resumeData.portfolio ? `<p><strong>Portfolio:</strong> <a href="${resumeData.portfolio}">${resumeData.portfolio}</a></p>` : ''}
              </div>
          </div>
