...
const Signup = () => {
  const [formData, setFormData] = useState({
    ...
    email: "",
    password: "",
    phone: "", // NEW: Add phone field to state
      ...
      >
        ...
        {!otpSent ? ( // Show registration form
          <>
            ...
            <div className="mb-4 animate-fade-in-up delay-350">
              <label htmlFor="phone" className={`block text-sm font-medium mb-1 ${textColor}`}>Phone Number</label>
              <input
                name="phone"
                id="phone"
