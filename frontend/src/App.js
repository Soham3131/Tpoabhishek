...
import CorporateEventDetailsPage from "./pages/CorporateEventDetailsPage";// Adjust the path as needed
    ...
    <Router>
      ...
      <Routes>
        ...
        <Route path="/podcasts" element={<PodcastsPage />} />
         <Route path="/corporate-events" element={<CorporateEventsPage />} /> {/* NEW: Route for Podcasts Listing */}
        ...
        <Route path="/podcasts/details/:id" element={<PodcastDetailPage />} />
         <Route path="/corporate-events/details/:id" element={<CorporateEventDetailsPage />} />
 {/* NEW: Route for Podcast Detail */}
