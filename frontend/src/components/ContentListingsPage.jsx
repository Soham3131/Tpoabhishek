...
// import { TrashIcon, MagnifyingGlassIcon, CalendarIcon, BriefcaseIcon, MapPinIcon } from '@heroicons/react/24/solid'; // Removed FunnelIcon as it's no longer needed for category filter
// import { Link } from 'react-router-dom';

// const ContentListingsPage = ({ title, endpoint, deleteEndpoint, detailPageBasePath }) => {
//   const { user } = useAuth();
...
//   // useEffect for categoryFilter debounce removed

//   // Function to determine dynamic hero text
//   const getHeroText = useMemo(() => {
//     switch (title) {
//       case "Job":
//         return {
...
//   useEffect(() => {
//     fetchContent();
//   }, [endpoint, debouncedSearchTerm, debouncedLocationFilter]); // debouncedCategoryFilter removed from dependencies

//   const handleDelete = async (itemId, itemName) => {
//     if (!user || user.role !== 'admin') {
//       // Using a custom message box instead of alert() - you'll need to implement this
//       // For now, I'll keep the alert as it was in your original code to avoid breaking functionality
...
//           <div className="bg-white rounded-xl shadow-lg p-6 grid grid-cols-1 md:grid-cols-2 gap-4 animate-fade-in-up animation-delay-400"> {/* Changed to md:grid-cols-2 */}
//             <div className="relative">
//               <input
//                 type="text"
//                 placeholder="Keywords (e.g., React, Sales)"
//                 value={searchTerm}
...
//               <input
//                 type="text"
//                 placeholder="Location (e.g., New Delhi, Bangalore, New York)" /* Updated placeholder */
...
//             </div>
//             {/* Category Filter section removed */}
//             {/* Clear Filters Button (now spans 2 columns) */}
//             <button
//               onClick={() => { setSearchTerm(''); setLocationFilter(''); }} // Removed setCategoryFilter
//               className="md:col-span-2 mt-4 w-full bg-gray-200 hover:bg-gray-300 text-[#2D3436] font-semibold py-3 px-6 rounded-lg transition duration-300 ease-in-out shadow-md hover:shadow-lg"
//             >
//               Clear Filters
//             </button>
//           </div>
...
// frontend/src/components/ContentListingsPage.jsx
