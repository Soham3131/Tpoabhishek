      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-300">
            ...
            <li>WhatsApp: <a href="https://wa.me/918816026108" target="_blank" className="hover:text-[#FF6B35] transition">+91 88160 26108</a></li>
        ...
        <div>
          ...
          <div className="flex items-center space-x-4 text-2xl mt-2">
            <motion.a whileHover={{ scale: 1.3, color: "#1877F2" }} href="#" className="transition"><FaFacebookF /></motion.a>
            <motion.a whileHover={{ scale: 1.3, color: "#E1306C" }} href="#" className="transition"><FaInstagram /></motion.a>
            <motion.a whileHover={{ scale: 1.3, color: "#0077B5" }} href="#" className="transition"><FaLinkedinIn /></motion.a>
            <motion.a whileHover={{ scale: 1.3, color: "#25D366" }} href="https://wa.me/918816026108" target="_blank" className="transition"><FaWhatsapp /></motion.a>
          </div>
        </div>
      </div>
