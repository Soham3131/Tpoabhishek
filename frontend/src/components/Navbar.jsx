...
//   ["Corporate Events", "/corporate-events"], // <--- ADDED THIS LINE
//     ];
...
//     return (
//         <nav className="h-20 bg-gradient-to-r from-[#1E3A5F] via-[#2e567e] to-[#1E3A5F] text-white shadow-3xl animate-fade-in-down relative z-50">
//             <div className="container mx-auto px-6 pr-4 flex items-center justify-between h-full">
//                 {/* Logo */}
//                 <div className="flex-shrink-0">
//                     <Link to={getHomeLink()} className="flex items-center transform hover:scale-105 transition-transform duration-200">
//                         <img src={logo} alt="Logo" className="h-[4rem] w-auto object-contain drop-shadow-lg" />
//                     </Link>
//                 </div>
...
const Navbar = () => {
    ...
    const handleMobileLinkClick = () => {
        setMobileMenuOpen(false);
        setServicesOpen(false); // Close nested services dropdown too
    ...
    return (
        <nav className="h-20 bg-gradient-to-r from-[#1E3A5F] via-[#2e567e] to-[#1E3A5F] text-white shadow-3xl animate-fade-in-down relative z-50">
            ...
            {mobileMenuOpen && (
                <div ref={mobileMenuRef} className="md:hidden bg-[#2e567e] text-white px-6 py-4 space-y-4 animate-fade-in-down">
                    {isLoggedIn && (
                        // A div with a ref for outside click detection
                        <div ref={profileDropdownRef} className="pb-4 border-b border-gray-400/50">
                            <button
                                onClick={(e) => {
                                    e.stopPropagation();
                            ...
                            {profileDropdownOpen && (
                                <div className="mt-4 w-full bg-white rounded-lg shadow-xl py-4 z-50 text-[#2D3436] animate-fade-in-up-dropdown overflow-hidden border border-[#4A789C]">
                                    <UserProfileEditor onCloseDropdown={handleMobileLinkClick} />
                                </div>
                            )}
                        </div>
                    )}
                    ...
                    {[
                        ...
                        <Link key={item.name} to={item.link} className="block py-2 hover:text-[#FF6B35]" onClick={handleMobileLinkClick}>
                            {item.name}
                        </Link>
                    ))}
                    ...
                    <div>
                        ...
                        <div className="ml-4 space-y-2">
                            {servicesItems.map(([label, link]) => (
                                <Link key={label} to={link} className="block hover:text-[#FF6B35]" onClick={handleMobileLinkClick}>
                                    {label}
                                </Link>
                            ))}
                        </div>
                    ...
                    <div className="pt-4">
                        {isLoggedIn ? (
                            ...
                            <>
                                <Link to="/signup" className="block w-full bg-[#FF6B35] py-2 rounded-lg text-center mb-2" onClick={handleMobileLinkClick}>
                                    Sign Up
                                </Link>
                                <Link to="/login" className="block w-full border-2 border-white py-2 rounded-lg text-center" onClick={handleMobileLinkClick}>
                                    Login
                                </Link>
                            </>
                        )}
